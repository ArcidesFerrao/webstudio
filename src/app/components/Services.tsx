...
export default function Services() {
  ...
  return (
    ...
    >
      ...
      <p className="  max-w-md text-center">{t("services_subtitle")}</p>
      <div className="services-container flex justify-between w-full max-w-4xl">
        <div className="card p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow text-center ">
          <h3 className="mb-2">{t("service_landing_pages")}</h3>
          <p>{t("landing_pages_desc")}</p>
          <div>
            <h4 className="text-xs ">{t("services_starting_at")}</h4>
            <h4 className="font-medium">10 000,00 MZN</h4>
          </div>
        </div>
        <div className="card p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow ">
          <h3 className="mb-2">{t("service_website")}</h3>
          <p>{t("website_desc")}</p>
          <div>
            <h4 className="text-xs ">{t("services_starting_at")}</h4>
            <h4 className="font-medium">15 000,00 MZN</h4>
        ...
        <div className="custom-service card p-6 rounded-xl shadow-md hover:shadow-xl transition-shadow ">
          <h3 className="text-xl font-semibold mb-2 ">{t("service_custom")}</h3>
          <p>{t("custom_desc")}</p>
          <div>
            {/* <h4>
              <Link className="font-semibold" href="#contact">
            ...
            <h4 className="text-xs font-light">{t("custom_button")}</h4>
          </div>
        </div>
      </div>
      <Link href="#contact">
