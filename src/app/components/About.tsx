...
//           </div>
//           <p>
//             I&apos;m also launching Evolure Academy to teach real dev skills.
//           </p>
//         </div>
//         <div>
//           <Image
...
export default function About() {
  ...
  return (
    <section id="about" className="about flex flex-col items-center p-10 gap-5">
      <h2 className="text-4xl font-bold bg-clip-text ">{t("about_title")}</h2>
      <div className="flex flex-col gap-5">
        <div className="about-container flex gap-5 items-center">
          <div className="flex flex-col gap-5">
            <p className="flex gap-1">{t("about_subtitle")}</p>
            <div className="flex flex-col gap-5">
              <p>{t("about_description")}</p>
              <ul className="px-5">
                <li className="font-extralight">{t("about_list_1")}</li>
                <li className="font-extralight">{t("about_list_2")}</li>
                <li className="font-extralight">{t("about_list_3")}</li>
              </ul>
            </div>
            {/* <p>
              I&apos;m also launching Evolure Academy to teach real dev skills.
